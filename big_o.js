...
function addAndLog(array) {
 for (var i = 0; i < array.length; i++) {
  console.log("OUTER array[i] ", array[i]);
   for (var j = 0; j < array.length; j++) {
     console.log("inner array[i] ", array[i]);
     console.log("inner array[j] ", array[j]);
